...
class SFTP:
    def __init__(self, **kwargs):
        ...
        self.batchfile_path = kwargs.get("batchfile_path", f"{constants.TMP_DIR}/sftpBatchFile.txt")
    ...
    def start_send_sftp_pool(self, file_src, file_dst):
        ...
        try:
            ...
            cmd = f"{self.linux_sftp_bin} -p -b {self.batchfile_path} -P {int(self.port)} -i {self.pkey_file} {user_host}"
